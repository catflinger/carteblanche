...
angular.module("cbApp").factory("grid", [function () {
    ...
    var GridCell = function (data) {
        return {
            ...
            getStyle: function () {
                ...
                //use either background color or bars but not both
                if (this.black) {
                    result = {
                    ...
                    result = {
                        'background-color': this.selected ? 'skyblue' : 'white',
                        'border-right': 'solid black ' + (this.rightbar ? '3px' : '1px'),
                        'border-bottom': 'solid black ' + (this.bottombar ? '3px' : '1px')
                    };
                }
    ...
    var _getCells = function (x, y, direction, len) {
        var i;
        var result = [];
